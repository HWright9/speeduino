...
void loop()
{
    ...
    if (BIT_CHECK(LOOP_TIMER, BIT_TIMER_1HZ)) //Once per second)
    {
      ...
      //MCP2515 - This resets the CAN error allowing CAN to soft-recover after 2sec
      #if defined CAN_AVR_MCP2515
      can0_Maintainance();
      #endif
    ...
    if ((currentStatus.hasSync || BIT_CHECK(currentStatus.status3, BIT_STATUS3_HALFSYNC)) && (currentStatus.RPM > 0))
    {
      ...
      currentStatus.injCloseAngle = 720 - table2D_getValue(&injectorAngleTable, currentStatus.RPMdiv100);
...
{
  uint16_t tempInjectorStartAngle = (currentStatus.injCloseAngle + injChannelDegrees);
...
{
  if ((configPage10.spark2Mode == SPARK2_MODE_BANKED) && (configPage9.injBank_Inj1 == INJ_BANK2)) { ignition1EndAngle = CRANK_ANGLE_MAX_IGN - currentStatus.advance2; }
  else { ignition1EndAngle = CRANK_ANGLE_MAX_IGN - currentStatus.advance; }
...
{
  if ((configPage10.spark2Mode == SPARK2_MODE_BANKED) && (configPage9.injBank_Inj2 == INJ_BANK2)) { ignition2EndAngle = channel2IgnDegrees - currentStatus.advance2; }
  else { ignition2EndAngle = channel2IgnDegrees - currentStatus.advance; }
...
{
  if ((configPage10.spark2Mode == SPARK2_MODE_BANKED) && (configPage9.injBank_Inj3 == INJ_BANK2)) { ignition3EndAngle = channel3IgnDegrees - currentStatus.advance2; }
  else { ignition3EndAngle = channel3IgnDegrees - currentStatus.advance; }
...
{
  if ((configPage10.spark2Mode == SPARK2_MODE_BANKED) && (configPage9.injBank_Inj4 == INJ_BANK2)) { ignition4EndAngle = channel4IgnDegrees - currentStatus.advance2; }
  else { ignition4EndAngle = channel4IgnDegrees - currentStatus.advance; }
...
{
  if ((configPage10.spark2Mode == SPARK2_MODE_BANKED) && (configPage9.injBank_Inj5 == INJ_BANK2)) { ignition5EndAngle = channel5IgnDegrees - currentStatus.advance2; }
  else { ignition5EndAngle = channel5IgnDegrees - currentStatus.advance; }
...
{
  if ((configPage10.spark2Mode == SPARK2_MODE_BANKED) && (configPage9.injBank_Inj6 == INJ_BANK2)) { ignition6EndAngle = channel6IgnDegrees - currentStatus.advance2; }
  else { ignition6EndAngle = channel6IgnDegrees - currentStatus.advance; }
...
{
  if ((configPage10.spark2Mode == SPARK2_MODE_BANKED) && (configPage9.injBank_Inj7 == INJ_BANK2)) { ignition7EndAngle = channel7IgnDegrees - currentStatus.advance2; }
  else { ignition7EndAngle = channel7IgnDegrees - currentStatus.advance; }
...
{
  if ((configPage10.spark2Mode == SPARK2_MODE_BANKED) && (configPage9.injBank_Inj8 == INJ_BANK2)) { ignition8EndAngle = channel8IgnDegrees - currentStatus.advance2; }
  else { ignition8EndAngle = channel8IgnDegrees - currentStatus.advance; }
