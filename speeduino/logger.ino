...
byte getTSLogEntry(uint16_t byteNum)
{
  ...
  switch(byteNum)
  {
    ...
    case 97: statusValue = (byte)(currentStatus.vvt1Duty); break;
    case 98: statusValue = lowByte(currentStatus.flexBoostCorrection); break;
    case 99: statusValue = highByte(currentStatus.flexBoostCorrection); break;
    case 100: statusValue = currentStatus.baroCorrection; break;
    case 101: statusValue = currentStatus.VE; break; //Current VE (%). Can be equal to VE1 or VE2 or a calculated value from both of them
    case 102: statusValue = currentStatus.ASEValue; break; //Current ASE (%)
    case 103: statusValue = lowByte(currentStatus.vss); break;
    case 104: statusValue = highByte(currentStatus.vss); break;
    case 105: statusValue = currentStatus.gear; break;
    case 106: statusValue = lowByte(currentStatus.fuelPressure); break; //2 bytes for fuelPressure
    case 107: statusValue = highByte(currentStatus.fuelPressure); break;
    case 108: statusValue = currentStatus.oilPressure; break;
    case 109: statusValue = currentStatus.status4; break;
    case 110: statusValue = lowByte(currentStatus.vvt2Angle); break; //2 bytes for vvt2Angle
    case 111: statusValue = highByte(currentStatus.vvt2Angle); break;
    case 112: statusValue = currentStatus.vvt2TargetAngle; break;
    case 113: statusValue = (byte)(currentStatus.vvt2Duty); break;
    case 114: statusValue = currentStatus.outputsStatus; break;
    case 115: statusValue = (byte)(currentStatus.fuelTemp + CALIBRATION_TEMPERATURE_OFFSET); break; //Fuel temperature from flex sensor
    case 116: statusValue = currentStatus.fuelTempCorrection; break; //Fuel temperature Correction (%)
