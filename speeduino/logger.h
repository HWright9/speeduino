...
#include <assert.h>
  ...
  #define LOG_ENTRY_SIZE      124 /**< The size of the live data packet. This MUST match ochBlockSize setting in the ini file */
  #define SD_LOG_ENTRY_SIZE   124 /**< The size of the live data packet used by the SD car.*/
