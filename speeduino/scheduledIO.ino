...
void tachoOutputOn() { if(configPage6.tachoMode_dwell) { TACHO_PULSE_LOW(); } else { tachoOutputFlag = READY; } }
void tachoOutputOff() { if(configPage6.tachoMode_dwell) { TACHO_PULSE_HIGH(); } }
